...
// The product's user-facing name (chrome://extensions entry + toolbar tooltip)
// reads from the ONE source (golden rule 4) — settling the TBD name is a single
// coreConfig.siteName edit, no code change here.
